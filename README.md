...
Running locally:
```
python workflows/gpt/model/train.py --modelType=tensorflow_char --modelVersion=tf_20220426 --dataSource=shakespeare
python workflows/gpt/model/score.py --modelType=tensorflow_char --modelVersion=tf_20220426 --dataSource=shakespeare
```
